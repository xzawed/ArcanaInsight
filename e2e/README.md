...
Playwright 기반 E2E 테스트 실행·작성·검증에 대한 Single Source of Truth.
...
> 참조: [`e2e/helpers/sse-mock.ts`](./helpers/sse-mock.ts)
