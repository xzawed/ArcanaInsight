...
> **전체 가이드**: **[docs/workflow/e2e-testing.md](../docs/workflow/e2e-testing.md)**
>
...
Windows(Claude Code)에서는 Docker 필수 → [§1.2 Windows Docker 실행](../docs/workflow/e2e-testing.md#12-windows-docker-실행-필수)
