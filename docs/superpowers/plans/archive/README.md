...
| `2026-07-07-reading-reliability-debt.md` | 2026-07-07 | 리딩 신뢰성 기술부채(parseError 관측성 + 구 섹션 스키마 제거) | PR #499 |
| `i18n-consistency-fix.md` | (초기) | i18n 정합성 수정 | i18n 다국어 |
| `i18n-master-plan.md` | (초기) | i18n 마스터 플랜 | i18n 다국어 |

## 상위 디렉토리(활성 `plans/`) 현재 파일

**현재 활성 계획 없음.** 마지막 활성 계획이던 `2026-07-07-reading-reliability-debt.md`는 구현 완료로
2026-08-01 본 archive/로 이동했다(잔여였던 배포 후 검증 2건은 DB 계량 — 마이그 025 `parse_failures`,
PR #503 — 이 대체·상회한다).
