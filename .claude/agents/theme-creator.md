...
| ID | 이름 | 적용 시점 (auto) |
|----|------|------------------|
| midnight | 한밤의 신비 | 밤 20시~새벽 5시 (사용자 로컬 시간) |
| dawn | 새벽빛 여명 | 새벽 5시~8시 (사용자 로컬 시간) |
| sunset | 황혼의 노을 | 해질녘 17시~20시 (사용자 로컬 시간) |
| spring | 벚꽃 봄바람 | 3~5월, 낮 8시~17시 |
| summer | 한여름 밤 | 6~8월, 낮 8시~17시 |
| autumn | 가을 단풍 | 9~11월, 낮 8시~17시 |
| winter | 겨울 설경 | 12~2월, 낮 8시~17시 |
