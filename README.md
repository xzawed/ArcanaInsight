...
- **3가지 스프레드** — 원카드(1장) / 쓰리카드(3장·과거·현재·미래) / 켈틱 크로스(5장)
...
- **8가지 주제** — 연애, 직장, 재정, 건강, 종합, 3년/5년/전체 운세

### 캐릭터 시스템
4명의 캐릭터가 각각 다른 말투와 전문 분야로 상담합니다.

| 캐릭터 | 전문 | 말투 |
|--------|------|------|
| 🌙 아르카나 | 타로 | 부드럽고 신비로운 톤 (~네요/~해요) |
| ⛩️ 미코 | 신점·사주 | 차분하고 엄숙한 톤 (~입니다/~합니다) |
| 🌸 선화 | 사주 | 우아하고 따뜻한 톤 (~세요/~랍니다) |
| ⭐ 호시 | 오늘의 운세 | 반말 + 이모지 (~야/~지) |
...
│   ├── characters/             # 4캐릭터 설정 + 대기 대사 (타로/사주별)
│   ├── home/                   # FAQ, 후기, 통계 데이터
