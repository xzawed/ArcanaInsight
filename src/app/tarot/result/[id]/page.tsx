    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 relative">
        ...
        <div className="text-center mb-8">
          <h1 className="text-2xl font-display font-bold text-arcana-purple mb-2 drop-shadow-md">타로 리딩 결과</h1>
        ...
        <div className="space-y-4 mb-8">
          {interpretations.map((interp) => {
            ...
            return (
              <div key={interp.cardId} className="bg-arcana-card/80 backdrop-blur-sm border border-arcana-border rounded-2xl p-5">
        ...
        <div className="bg-arcana-surface/80 backdrop-blur-sm border border-arcana-purple/30 rounded-2xl p-6 mb-4">
        ...
        <div className="bg-arcana-surface/80 backdrop-blur-sm border border-arcana-gold/30 rounded-2xl p-6 mb-8">
        ...
        <div className="text-center">
          <a href="/tarot" className="inline-block px-8 py-3 rounded-full bg-gradient-to-r from-arcana-purple to-arcana-indigo text-white font-display font-bold hover:opacity-90 transition-opacity shadow-lg shadow-arcana-purple/30">나도 타로 상담 받기</a>
        </div>
      </div>
    </div>
  );
