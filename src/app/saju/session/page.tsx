              ...
              <div className="space-y-3 flex-1 overflow-y-auto pr-2">
                ...
                {readingResult.topicReading && (
                  <div className="bg-arcana-card/70 backdrop-blur-sm border border-arcana-border rounded-2xl p-4">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-lg">🔍</span>
                      <span className="text-arcana-gold font-serif font-bold">주제별 해석</span>
                    </div>
                    <p className="text-arcana-text text-sm leading-relaxed whitespace-pre-wrap">{readingResult.topicReading}</p>
                  </div>
                )}
