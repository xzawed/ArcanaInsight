...
export const faqItems: FAQItem[] = [
  ...
  { question: "캐릭터마다 해석이 다른가요?", answer: "네! 12명의 상담사는 각자 고유한 성격과 말투를 가지고 있어 같은 카드도 다른 관점에서 해석합니다. 아르카나는 신비롭고 따뜻하게, 미코는 영적으로 깊게, 선화는 우아하고 지혜롭게, 하루는 친근하게 응원하는 등 캐릭터마다 결이 다릅니다." },
];
