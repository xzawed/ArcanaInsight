...
export const sajuTimeOptions: SajuTimeOption[] = [
  { id: "this-week",    label: "이번 주",   labelEn: "This Week",  labelJa: "今週",      icon: "saju-week",     desc: "7일간 일운",          descEn: "Daily fortune for 7 days",     descJa: "7日間の日運",          allowMonthly: false, calcOption: { daily: true } },
...
export const sajuAreaOptions: SajuAreaOption[] = [
  ...
  { id: "saju-love-couple",     label: "연애 (커플)",  labelEn: "Love (Couple)",   labelJa: "恋愛(交際中)",icon: "saju-love-couple",  desc: "관계 발전·갈등 해결", descEn: "Growth & resolving conflict", descJa: "関係の発展・葛藤解決" },
  { id: "saju-career",          label: "직장·재물",    labelEn: "Career & Wealth", labelJa: "仕事・財運", icon: "saju-career",        desc: "직장·사업·금전운",    descEn: "Career, business & money", descJa: "仕事・事業・金運" },
  { id: "saju-health",          label: "건강운",       labelEn: "Health",          labelJa: "健康運",     icon: "saju-health",        desc: "건강·체질·오행",      descEn: "Health, body & five elements", descJa: "健康・体質・五行" },
  { id: "saju-personality",     label: "성격·적성",    labelEn: "Personality & Aptitude", labelJa: "性格・適性", icon: "saju-personality", desc: "성격·적성·직업 분석", descEn: "Personality & aptitude", descJa: "性格・適性・職業分析" },
  { id: "saju-compatibility",   label: "궁합",         labelEn: "Compatibility",   labelJa: "相性",       icon: "saju-compatibility", desc: "인연 경향·궁합 분석", descEn: "Bonds & compatibility", descJa: "縁の傾向・相性分析" },
  { id: "saju-auspicious-date", label: "택일",         labelEn: "Auspicious Date", labelJa: "吉日選定",   icon: "saju-date",          desc: "길일·흉일 판단",      descEn: "Choosing good & bad days", descJa: "吉日・凶日の判断" },
];
